...
export const Button: React.FC<ButtonProps> = ({ text, onClick }) => {
    return (
        <button onClick={onClick}>
            ...
            >
                <div className="flex justify-between text-center items-center mix-blend-difference text-gray-100">
                    {text}
                </div>
            </div>
        </button>
...
export const LargeButton: React.FC<ButtonProps> = ({ text, onClick }) => {
    return (
        <button onClick={onClick}>
            ...
            >
                <p className="flex w-full justify-center text-center items-center mix-blend-difference text-gray-100">
                    {text}
                </p>
            </div>
        </button>
